...
namespace ProxyOption3
{
    ...
    public class Command : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            // Convert to proxy
            var wallProxy = wallOrigin.ProxyCast<Wall, WallProxy>();
            var wallsProxy = wallsOrigin.ProxyCast<Wall, WallProxy>();

            // Convert back to revit entity
            var wall = wallProxy.ProxyCast<Wall, WallProxy>();
            var walls = wallsProxy.ProxyCast<Wall, WallProxy>();
